...
let setups =
  [
    make_setup ~systematic:false ~encode_all_upfront ~data_block_count:200
      ~max_redundancy:0.50 ~data_block_size:10 ~data_loss_rate:0.20 ~rounds;
    (* make_setup ~systematic:true ~encode_all_upfront ~data_block_count:500 *)
